...
class DiscordNotifier:
    ...
    def send_opportunity_alert(self, scored_opportunity: ScoredOpportunity, position_size: float):
        ...
        try:
            ...
            embed.add_embed_field(
                name="Score",
                value=f"{scored_opportunity.score:.2f}/100",
                inline=True
            )
    ...
    def send_performance_report(self, metrics: Dict[str, Any]):
        ...
        try:
            ...
            embed.add_embed_field(
                name="Net P&L",
                value=f"${metrics.get('net_pnl', 0):.2f}",
                inline=True
            )
            
            embed.add_embed_field(
                name="ROI",
                value=f"{metrics.get('roi', 0):.2f}%",
                inline=True
            )
