...
trades_executed = Counter(
    "trades_executed_total", "Total number of trades executed", ["outcome", "side"]
)
...
win_rate = Gauge("win_rate_percentage", "Current win rate percentage")

active_positions = Gauge(
    "active_positions_count", "Number of currently active positions"
)
